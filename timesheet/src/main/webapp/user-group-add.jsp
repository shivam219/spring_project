                            ...
                            <form method="post" action="EditUser" id="EditUserForm">
                                <div class="row gx-3 mb-3 justify-content-center">
                                    <div class="col-md-4">
                                        <table>
                                            <tr>
                                                ...
                                                <input class="form-control" id="groupDesc" type="text"
                                                    placeholder="Enter Group Description" value="">
                                                <span class="form-text small text-danger ms-2  d-none">Specify Group
                                                    Description</span>
                                            </tr>
                                        </table>
                                    </div>
                                    ...
                                    <div class="row justify-content-center mt-3 ">
                                        <button class="btn btn-secondary px-3  mt-2 mt-sm-0 me-2 w-auto " type="button"
