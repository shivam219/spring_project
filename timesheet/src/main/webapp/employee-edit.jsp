                        ...
                        <form method="post" action="EditUser" id="EditUserForm"  >
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="firstName" type="text" placeholder="Enter  first name" value="${emp.getFirstName()}">
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="birthDate" type="date" name="birthday" placeholder="Enter  birthday" value="${emp.getBirthDate()}">
                                    ...
                                    <div class="border p-2 rounded " style="border: 3px;">
                                        <c:if test='${emp.getGender().equals("M")}'>
                                            <div class="form-check d-inline-flex mt-1 ">
                                                <input class="form-check-input" type="radio" value="M" id="flexCheckDefault" name="gender" checked>
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    &nbsp;Male        
                                                </label>
                                            </div>
                                            <div class="form-check d-inline-flex ms-2">
                                                <input class="form-check-input" type="radio" value="F" id="flexCheckChecked" name="gender">
                                        ...
                                        <c:if test='${!emp.getGender().equals("M")}'>
                                            <div class="form-check d-inline-flex mt-1 ">
                                                <input class="form-check-input" type="radio" value="M" id="flexCheckDefault" name="gender" >
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    &nbsp;Male        
                                                </label>
                                            </div>
                                            <div class="form-check d-inline-flex ms-2">
                                                <input class="form-check-input" type="radio" value="F" id="flexCheckChecked" name="gender" checked>
                                                <label class="form-check-label" for="flexCheckChecked">
                                                    &nbsp; Female
                                                </label>
                                            </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="empPhone" type="text" placeholder="Enter  phone number" value="${emp.getEmpPhone()}">
                            ...
                            <div class="row gx-3 ">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control" id="empEmail" type="email" placeholder="Enter  email address" value="${emp.getEmpEmail()}">
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="empCity" type="text" placeholder="Enter City" value="${emp.getEmpCity()}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control  input-sm" id="empPincode" type="number" name="birthday" placeholder="Enter Pincode" value="${emp.getEmpPincode()}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <textarea class="form-control" id="empAddress" type="text" placeholder="Enter Address" value="">${emp.getEmpAddress()}</textarea>
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="dateOfJoin" type="date"  value="${emp.getDateOfJoin()}" readonly  >
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="dateOfResign" type="date"  value="${emp.getDateOfResign()}">
                                    <span class="form-text small text-muted ms-2 "  >Optional For Now</span>  
                                </div> 
                            </div>
                            <!-- Save changes button-->
                            <div class="row justify-content-center ">
                                <button class="btn btn-secondary px-5  mt-2 mt-sm-0 me-3 w-auto " type="button" onclick="history.back()" > Back  </button>
