...
<body>
					...
					<div class="row justify-content-center">
						<div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
							...
							<div class="card mb-3">
								<div class="card-body">
									<div class="pt-4 pb-2">
										<h5 class="card-title text-center pb-0 fs-4">Chang Password</h5>
										<p class="text-center small">Enter new Password </p>
									</div>
									<form class="row g-3" id="forgetpass" method="post" action="forget-pass-change-pass"
										enctype="multipart/form-data">
										<div class="col-12">
											<label for="yourUsername" class="form-label">Password</label>

											<div class="input-group has-validation">
												<span class="input-group-text"> <i class="fa fa-duotone fa-lock"></i>
												</span>
												<input type="password" name="password" class="form-control d-block"
													id="password" required>
											</div>
											<label class="form-text  text-danger" id="invalidPasswordWar">
												${error}
											</label>
										</div>
										<div class="col-12">
											<button class="btn btn-success w-100" type="submit" id="btnSubmit">
												<span id="loadingBtn"> </span> &nbsp; Change Password &nbsp;
											</button>
										</div>
										<div class="col-12">
	...
	<script>
		...
		$("input").on("input", function () {
			$("#invalidPasswordWar").addClass("d-none");
		});
	</script>
