        ...
        <div class="row align-items-center mt-3 mb-2">
            ...
            <div class="col-md-6 "> 
                <div class="d-flex justify-content-md-end ">                          
					<a type="button" class="btn btn-primary btn-sm btn-sm align-self-center align-items-center" href="holiday-master-add">  <i class="bx bx-plus me-1"></i>  Create Holiday</a>
		        </div>
            </div>
        </div>
        <div class="row">
