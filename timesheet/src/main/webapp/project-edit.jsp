    ...
    <div class="container-xl px-4 mt-4">
        <div class="row px-4 ">
            <div class="col col-xl-12">
                <div class="card mb-4">
                    <div class="card-header text-center">Edit Project</div>
                    <div class="card-body">
                        <form method="post" action="project-process" id="addProjectForm"  >
                            <div class="row gx-3 mb-3 justify-content-center">
                                <div class="col-md-6 col-lg-4">
                                <table>
                                    <input type="hidden" value="${project.getProjectId()}" id="projectId">
                                       
                                    <tr>
                                        <div>
                                            <label class="small mb-1" for="projectName"> Project Name</label>
                                            <input class="form-control" id="projectName" type="text" placeholder="Enter Project Name" value="${project.getProjectName()}">
                                    ...
                                    <tr>
                                        <div>
                                            ...
                                            <select id="projectStatus" class="form-control form-select">
                                                <c:if test="${project.getProjectStatus()== 1  }">
                                                    <option value="1" selected >Active</option>
                                                    <option value="0">In-Active</option>
												</c:if>
                                                <c:if test="${project.getProjectStatus()== 0}">
                                    ...
                                    <tr>
                                        ...
                                        <select id="customerId" class="form-control form-select">
                                            ...
                                            <c:forEach items="${customerList}" var="c" varStatus="loop">
                                                <option value="${project.getCustomer().getCustomerId()}" <c:if test="${project.getCustomer().getCustomerId() eq c.getCustomerId()}">selected="selected"</c:if>  >${c.getCustomerName()} </option>
                                            </c:forEach>        
                                        </select>
