							...
							<div class="card mb-3">
								<div class="card-body">
									<div class="pt-4 pb-2">
										...
										<p class="text-center small">Enter your ESS Email </p>
									</div>

									<form class="row g-3" id="forgetpass" method="post" action="forget-pass"
										...
										<div class="col-12">
											...
											<div class="input-group has-validation">
												...
												<input type="email" name="email" class="form-control d-block "
													id="email" required>
											</div>
