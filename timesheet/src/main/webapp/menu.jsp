	...
	<nav class="navbar navbar-expand-lg bg-nav-foot " >
		<div class="container-fluid">
			...
			<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
				<i class="fas fa-sliders-h"></i> <!-- <span class="navbar-toggler-icon">	</span> -->
			</button>
			<div>
				<li class="nav-item d-none d-lg-block ">
					<a class="navbar-brand" href="#"> 
						<img src="images/esslogo.jpg" alt="" width="70" height="40" class="d-inline-block align-text-top">
					</a>
				</li>
			</div>
			<div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
				<div class="justify-content-end">
					<ul class="navbar-nav">
						<li class="nav-item  me-3"><a class="nav-link active" aria-current="page" href="home">Home</a></li>
					...
					<li class="nav-item dropdown ms-2"><a class="nav-link dropdown-toggle" href="dropdown-menu" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Create Timesheet </a>
						<ul class="dropdown-menu" id="dropdown-menu">
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle ms-2" href="dropdown-menu" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Leave Application </a>
						<ul class="dropdown-menu" id="dropdown-menu">
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle ms-2" href="dropdown-menu" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Reports </a>
						<ul class="dropdown-menu" id="dropdown-menu">
					...
					<li class="nav-item dropdown"><a class="nav-link dropdown-toggle ms-3" href="dropdown-menu" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Admin </a>
						<ul class="dropdown-menu" id="dropdown-menu">
				    ...
				    <li class="nav-item dropdown no-arrow">
						<div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link ms-2" aria-current="page"  data-bs-toggle="dropdown" href="#"><i class="fa-solid fa-circle-user"></i><span class="d-none d-lg-inline me-2 text-gray-600">&nbsp;&nbsp;Sandeep Gupta</span></a>
							<div class="dropdown-menu shadow dropdown-menu-end animated--grow-in"><a class="dropdown-item text-dark" href="logout"><i class="fas fa-sign-out-alt fa-sm fa-fw me-2 text-dark-400"></i>&nbsp;Logout</a></div>
						</div>
					</li>
					</ul>
					</div>
