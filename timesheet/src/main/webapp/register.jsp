...
<body>
		...
		<form method="post" action="registerprocess">
			<div class="row justify-content-center py-2">
				<div class="col-lg-4  ">
					<div class="input-group mb-3">
						...
						<div class="form-floating">
							<input type="text" class="form-control" id="empId" name="empId" placeholder="Username"  autocomplete="new-password">
					...
					<div class="input-group mb-3">
						<span class="input-group-text"> <i class="fa-solid fa-user"></i> </span>
						<div class="form-floating">
							<input type="text" class="form-control" id="empName" name="empName" placeholder="Username"  autocomplete="new-password">
				...
				<div class="col-lg-4  p-2 justify-content-center ">
					<div class="input-group mb-3">
