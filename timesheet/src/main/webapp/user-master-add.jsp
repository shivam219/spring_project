                        ...
                        <form method="post" action="EditUser" id="EditUserForm"  >
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="empId" type="text" placeholder="Enter  Code" value="${emp.getEmpId()}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="empPassword" type="text" placeholder="Enter  Password" value="${emp.getEmpPassword()}">
                                ...
                                <div class="col-md-4 ">
                                    ...
                                    <div class="border p-2 rounded " style="border: 3px;">
                                        ...
                                        <div class="form-check d-inline-flex ms-2">
                                            <input class="form-check-input" type="radio" value="" id="flexCheckChecked" name="gender" checked>
                            ...
                            <div class="row gx-3 ">
                                ...
                                <div class="col-md-4 ">
                                 ...
                                 <div class="col-md-4 mb-3">
                                    <label class="small mb-1" for="managerId">Email address</label>
                                    <input class="form-control" id="managerId" type="email" placeholder="Enter  email address" value="Vigneswari Mam" readonly>
                                    <span class="form-text small text-danger ms-2  d-none"  >Specify Manager Name</span>
                                </div>
                            </div>
                            <div class="row gx-3 mb-3">
                                <!-- Form Group (City)-->
                            ...
                            <button class="btn btn-danger px-4 ms-4 " type="reset" onclick="this.blur()" > Reset  </button>
                        </form>
                    </div>
                </div>
            </div>
