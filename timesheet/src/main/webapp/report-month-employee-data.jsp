                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  <table class="table  project-list-table align-middle table-borderless">
                    <thead class="thead-dark"> 
                      <td class="text-center " scope="row">Type</td>
                      <td class="text-center " scope="row">From</td>
                      <td class="text-center " scope="row">To</td>
                      <td class="text-center " scope="row">Days</td>
                    </thead>
